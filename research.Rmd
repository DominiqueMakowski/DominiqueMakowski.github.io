...
```{r echo = FALSE, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.align='center', fig.cap="**Cumulative citations and publications number, automatically scrapped from Google Scholar.**"}
library(plotly)
library(scholar)
