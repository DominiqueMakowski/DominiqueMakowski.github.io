...
<p align="center">
```{r echo = FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap="**My research wordcloud, based on the most frequent words of my papers (done using R).**"}
library(wordcloud2)
library(pdftools)
library(tidyverse)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', include=FALSE}
library(slickR)
# library(imager)
# library(stringr)
